...
export default class TopNativeSlider extends React.Component {

	constructor(props) {
		super(props);
		this.props.dispatch(fetchTopNative(0, 10));
	}
	...
	render() {
		...
		return (
			<div>
				{this.props.topNativePostFetched ? <Swiper {...params}>
					{this.getSlides(this.props.topNative)}
				</Swiper> : null}
			</div>
		);
	}
